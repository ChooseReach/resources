    ...
    <div class="search2__item">
        ...
        <div class="search2__content">
            ...
            <div class="search2__buttons">
                ...
                <% if (!!listing.properties.orderEZCater) { %><a id="Search-Catering-Button" href="<%= listing.properties.orderEZCater %>" target="_blank" class="button button--order">Catering</a><% } %>
